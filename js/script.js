...
// if (randomNumber == '1') {computerMove = 'stone';} 
// else if (randomNumber == '2') {computerMove = 'paper';}
// else if (randomNumber == '3') {computerMove = 'scissors';}
// else {computerMove = 'unknown traffic';}


// printMessage ('My move:' + computerMove);


// playerInput = prompt ('choose your move, lad!: 1 for stone, 2 for paper, 3 for scissors! 😁')
...
{
    console.log ('creating displayResult funtion wuth arguements' + playerMove + computerMove);
    ...
    printMessage('Computer has choosen: ' + computerMove + ' and player has chosen: ' + playerMove );
}



playerMove = argButtonName
// playerInput = prompt ('Choose your move! 1: stone, 2: paper, 3: scissors.');
